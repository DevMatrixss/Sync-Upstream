...
if [[ $? -ne 0 ]]; then
    ...
    echo "Merge conflicts occurred during merging upstream branch: $UPSTREAM_BRANCH into downstream branch: $DOWNSTREAM_BRANCH."
    echo "Please follow these steps to resolve conflicts:"
    echo "  1. Open the conflicted files and manually resolve the conflicts."
    echo "  2. Once resolved, run the following commands:"
    echo "    git add ."
